...
namespace PLARNGGui
{
    public class RngRoutines 
    {
        ...
        public void ReadOutbreakID()
        {
            ...
            var coordsptr = new long[] { 0x42a6ee0, 0x330, 0x70 + group_id * 0x40 };
            var coordsoff = Main.routes.PointerAll(coordsptr).Result;
            var coords = Main.routes.ReadBytesAbsoluteAsync(coordsoff, 12).Result;
            var coordX = BitConverter.ToSingle(coords, 0);
            var coordy = BitConverter.ToSingle(coords, 4);
            var coordz = BitConverter.ToSingle(coords, 8);
            Program.main.Teleporterdisplay.AppendText($"Outbreak Group: {group_id}\nX: {coordX}\nY: {coordy}\nZ: {coordz}\n");
                    ...
                    if (species != 0)
                    {
                        ...
                        for (int h = 0; h < 4; h++)
                        {
                            ...
                            if (shiny)
                            {
                                ...
                                Program.main.Teleporterdisplay.AppendText($"Initial Spawn {h}\nShiny:{shiny}\nEC:{string.Format("{0:X}", encryption_constant)}\nPID:{string.Format("{0:X}", pid)}\nIVs:{ivs[0]}/{ivs[1]}/{ivs[2]}/{ivs[3]}/{ivs[4]}/{ivs[5]}\nAbility:{ability}\nGender:{gender}\nNature{((Nature)nature)}\nShinySeed{string.Format("0x{0:X}", generatorseed)}\n\n");
                        ...
                        if (bonusround != 0)
                        {
                            ...
                            for (int h = 0; h < 4; h++)
                            {
                                ...
                                if (shiny)
                                {
                                    ...
                                    Program.main.Teleporterdisplay.AppendText($"Initial Bonus Spawn {h}\nShiny:{shiny}\nEC:{string.Format("{0:X}", encryption_constant)}\nPID:{string.Format("{0:X}", pid)}\nIVs:{ivs[0]}/{ivs[1]}/{ivs[2]}/{ivs[3]}/{ivs[4]}/{ivs[5]}\nAbility:{ability}\nGender:{gender}\nNature{((Nature)nature)}\nShinySeed{string.Format("0x{0:X}", generatorseed)}\n\n");
                                    Program.main.Teleporterdisplay.AppendText($"Coords:\nX: {spawncoordx}\nY: {spawncoordy}\nZ: {spawncoordz}\n ");
                                }
                            }
                            ...
                            for (int p = 1; p < bonuscount - 3; p++)
                            {
                                ...
                                if (shiny)
                                {
                                    ...
                                    Program.main.Teleporterdisplay.AppendText($"Bonus Respawn {p}\nShiny:{shiny}\nEC:{string.Format("{0:X}", encryption_constant)}\nPID:{string.Format("{0:X}", pid)}\nIVs:{ivs[0]}/{ivs[1]}/{ivs[2]}/{ivs[3]}/{ivs[4]}/{ivs[5]}\nAbility:{ability}\nGender:{gender}\nNature{((Nature)nature)}\nShinySeed{string.Format("0x{0:X}", generator_seed)}\n\n");
                                    Program.main.Teleporterdisplay.AppendText($"Coords:\nX: {spawncoordx}\nY: {spawncoordy}\nZ: {spawncoordz}\n ");
                                }
                            }
                        }
